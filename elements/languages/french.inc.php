 ...
 * language.inc.php
 * 
 * Tell PHPDocumentor to ignore during development
 * @ignore
 * 
 ...
 * Messages
 */
DEFINE ('LANG_LOGIN_REQUEST', 'S\'il vous plaît entrer votre nom d\'utilisateur et mot de passe');
DEFINE ('LANG_FIRM_SELECT_REQUEST', 'S\'il vous plaît sélectionner un cabinet');
